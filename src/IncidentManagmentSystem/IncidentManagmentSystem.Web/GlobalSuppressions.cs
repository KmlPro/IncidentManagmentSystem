...
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "<Pending>", Scope = "member", Target = "~P:IncidentManagmentSystem.Web.UseCases.UpdateDraftApplications.UpdateDraftApplicationRequest.AddedAttachments")]
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "<Pending>", Scope = "member", Target = "~P:IncidentManagmentSystem.Web.UseCases.UpdateDraftApplications.UpdateDraftApplicationRequest.DeletedAttachments")]
