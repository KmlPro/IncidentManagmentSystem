...
using IncidentManagementSystem.ApiBehavioursTests.TestFixtures.IncidentReports.DraftApplicationFixtures;
    ...
    public class TestFixture
    {
        ...
        public MultipartFormDataContent CreateRequestContent(Guid suspiciousEmployee, Guid? draftApplicationId)
        {
            ...
            var formData = new MultipartFormDataContent
            {
                ...
                {new StringContent(description), nameof(PostApplicationRequest.Description)},
